...
INSERT INTO app_user (USERNAME, PASSWORD, ROLE, DELETED, CREATED_AT, UPDATED_AT)
VALUES ('customer_ali', '$2a$10$J55TWvjNxvue5ylB1wTsduABMCQWw2Jm9/QJsiDq9MgiCqmt.lGSC', 2, 0, NOW(), NOW());
SET @app_user_id = LAST_INSERT_ID();
...
INSERT INTO app_user (USERNAME, PASSWORD, ROLE, DELETED, CREATED_AT, UPDATED_AT)
VALUES ('customer_ebru', '$2a$10$J55TWvjNxvue5ylB1wTsduABMCQWw2Jm9/QJsiDq9MgiCqmt.lGSC', 2, 0, NOW(), NOW());
SET @app_user_id = LAST_INSERT_ID();
INSERT INTO customer_user (id, email, first_name, last_name, region)
VALUES (@app_user_id, 'customer_ebru@gmail.com', 'Ebru', 'Ozkara', 'Istanbul');

INSERT INTO app_user (USERNAME, PASSWORD, ROLE, DELETED, CREATED_AT, UPDATED_AT)
VALUES ('customer_tugba', '$2a$10$J55TWvjNxvue5ylB1wTsduABMCQWw2Jm9/QJsiDq9MgiCqmt.lGSC', 2, 0, NOW(), NOW());
SET @app_user_id = LAST_INSERT_ID();
INSERT INTO customer_user (id, email, first_name, last_name, region)
